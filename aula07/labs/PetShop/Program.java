		...
		while(true) {
	       ...
	       switch (escolha) {
              ...
              case "Cadastrar um animal":
            	  String escolhaAnimal = (String) JOptionPane.showInputDialog(
            		        null,
            		        "Escolha o tipo de animal:",
            		        "Cadastrar um animal",
            		        JOptionPane.PLAIN_MESSAGE,
            		        null,
            		        new String[] { "Cachorro", "Gato", "Pássaro" }, 
            		        "Cachorro"
            		    );
              ...
              case "Cadastrar um produto":
                  ...
                  int qntdEstoque = Integer.parseInt(JOptionPane.showInputDialog("Quantas unidades serão adicionadas ao estoque?"));
              ...
              break;
          	  ...
          	  case "Cadastrar um serviço":
          		String escolhaServico = (String) JOptionPane.showInputDialog(
          		        null,
          		        "Escolha o tipo de serviço:",
          		        "Cadastrar um serviço",
          		        JOptionPane.PLAIN_MESSAGE,
          		        null,
          		        new String[] { "Banho", "Tosa", "Consulta Veterinária", "Hospedagem"},
      		        	"Banho"
          		    );
                ...
                if (produtoEncontrado != null) {
                    if (quantidadeCompra <= produtoEncontrado.getQntdEstoque()) {
                        ...
                        JOptionPane.showMessageDialog(null, quantidadeCompra + " unidades de " + nomeProdutoCompra + " compradas com sucesso!");
                    } else {
                        JOptionPane.showMessageDialog(null, "Quantidade indisponível em estoque.");
                    }
                } else {
                    JOptionPane.showMessageDialog(null, "Produto não encontrado na lista. Produtos na lista: " + produtos);
                }
                break;
